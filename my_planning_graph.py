...
class PlanningGraph():
    ...
    def h_levelsum(self) -> int:
        ...
        goals_found = []
        for i, set in enumerate(self.s_levels):
            for pgnode_s in set:
                if (pgnode_s.literal == self.problem.goal or pgnode_s.literal in self.problem.goal) and pgnode_s.literal not in goals_found:
                    level_sum += i
                    goals_found.append(pgnode_s.literal)
